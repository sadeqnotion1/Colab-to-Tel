...
# Random thumbnail pool (472 images) for download/upload progress display
thumbnail_urls = [
    # LaurenBrzozowski
    ...
    try:  # Main try block for the entire task
        ...
        try:
            ...
            if not _msg.status_msg and not is_parallel_mode:
                ...
                # Delete individual status message if we're in parallel mode
                ...
                try:
                    ...
                    log.warning(
                        f"Failed to delete individual status message: {del_err}")
            else:
