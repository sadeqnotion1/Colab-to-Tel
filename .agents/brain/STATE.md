...
| Instagram Profile & Post Downloader Hook | ✅ | Added instagrapi profile/post hooks, session cookie self-healing, request_timeout=15 override, and clips_metadata validation patch (commit `74eb788`). |
