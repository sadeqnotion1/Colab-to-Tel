...
| Instagram Profile & Post Downloader Hook | ✅ | Added instagrapi profile + post hooks with instaloader fallback, root settings path lookup, and nested JSON cookies parsing. |
